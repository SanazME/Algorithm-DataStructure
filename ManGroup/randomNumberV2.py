...
class RandomGen(object):
    ...
    # Dependecy Injection
    def __init__(self, random_nums, probabilities, randomSource = random.random):
...
# mock unittest from python
    ...
    def testExactInput(self):
        random_nums = [2,5, 10]
        probabilities = [0.1,0.4, 0.5]
        obj = RandomGen(random_nums, probabilities, ConstRandom(0.1).random) 
